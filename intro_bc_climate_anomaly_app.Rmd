...
#### **Overview:**
 The BC climate anomaly app aims to provide insights into climate variations within British Columbia (BC) and its sub-regions (eco-provinces,eco-regions, eco-sections, Municipalities, major watersheds, <a href='https://www2.gov.bc.ca/gov/content/data/geographic-data-services/topographic-data/freshwater' target='_blank'> Freshwater Atlas (FWA) watersheds </a>, and <a href='https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/forest-landscape-plans' target='_blank'> Forest Landscape Plan (FLP) boundaries </a>). This tool facilitates the comparison of climate data (precipitation, temperature (minimum, maximum, and mean), vapor pressure deficit (VPD), relative humidity (RH), and soil moisture) against long-term averages and provides a visualization of the evolution of climate patterns over several decades since 1950. Developed as an R Shiny application, this tool is complemented by an informative report, offering a comprehensive understanding of climate variations within BC. The application is updated on a monthly basis, providing climate change information with a lag of approximately two weeks.The analysis covers the timeframe from 1951 to recent past month, with monthly updates to incorporate the most recent data. We used <a href='https://cds.climate.Copernicus.eu/cdsapp#!/data set/reanalysis-era5-land?tab=overview' target='_blank'> ERA5-Land hourly data</a> for calculating the climatological mean and anomalies. The anomalies are computed as deviations from the average climatic conditions observed between 1981 and 2010 (30-years).
 
This BC climate anomaly app aims to provide insights into climate variations, facilitates the comparison of climate data against long-term averages and provides a visualization of the evolution of climate patterns over several decades since 1951. The application is updated on a monthly basis, providing climate change information with a lag of approximately two weeks.
 
This is a product of the <a href ='https://www2.gov.bc.ca/gov/content/environment/natural-resource-stewardship/natural-resources-climate-change/future-forest-ecosystems-centre#:~:text=The%20Future%20Forest%20Ecosystems%20Centre%20(FFEC)%20was%20officially%20established%20in,on%20B.C.%27s%20forest%20ecosystems.' target='_blank'> Future Forest Ecosystems Center (FFEC)</a>. The FFEC is a scientific team that forecasts climate change impacts on B.C.'s forest ecosystems. The core role of the FFEC is to translate ecological knowledge into data, tools, and guidance to help ecosystem managers account for climate risks.

#### **Key features:**

-   **Climate anomaly and trends:** The app shows anomalies of climate parameters (temperature, precipitation, humidity, vapor pressure, and soil moisture) highlighting deviations from historical norms. It provides long term spatial and spatially average linear trends for selected region and time-period.

-   **Interactive Visualization**: It presents the data through intuitive maps, and time series plots, complete with trend magnitude and significance values.
