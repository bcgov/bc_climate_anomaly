...
ano_dt_sp_trn_sig_plt
  ...
  #Summary table for current month anomalies and spatial trends -----
    ano_dt_shp_rast_cur_mon <- subset(ano_dt_shp_rast, which(names(ano_dt_shp_rast) %in% curr_mon_yr))
    ano_dt_mon_sum_tab <-
      tibble::tibble(summary = summary(ano_dt_shp_rast_cur_mon))
    ano_dt_mon_sum_tab$mon <- curr_mon_yr
    ano_dt_mon_sum_tab$par <- parr
    # ano_dt_mon_sum_tab$val <- "ano"
    
    ano_trn_mag_shp<- crop(ano_trn_mag, sel_area_shpfl, mask = T)
# plot(ano_trn_mag_shp)
trn_dt_mon_sum_tab <-
  tibble::tibble(summary = summary(ano_trn_mag_shp))
ano_dt_mon_sum_tab$trn_summary <- trn_dt_mon_sum_tab$summary
   ...
   # plot(ano_dt_shp_rast,72)
    ...
    plts <-
      list(spatial_ano_mon_plt , spatial_ano_12mon_plt,ano_dt_sp_trn_sig_plt, ano_shp_trn_plt,ano_dt_mon_sum_tab)
    names(plts) <-
      c(
...
-   `r format(as.Date(curr_mon_yr), "%B-%Y")` was on average 3.75°C more warmer than normal.
-   `r format(as.Date(curr_mon_yr), "%B-%Y")` was drier then normal for lower latitude regions while wetter then normal at north-west region.
-   The average of previous 12 months climate parameters indicate that BC experienced substantially warmer and slightly drier climate then normal between `r prv_mon_nam` and `r cur_mon_nam`.
-   The mean `r cur_mon_nam`temperature in BC is increasing but the rate of increase is not statistically.
-   The long-term `r cur_mon_nam` precipitation indicate slight increase (0.23 mm per year) in spatially averaged total precipitation across BC .
...
#| fig-cap: !expr paste("Spatial trends of mean temperature and VPD anomalies for", cur_mon_nam ,":1950 - ",cur_yr_nam, ".The black dot indicates grid cells with statistically signficnat trends. Anomalies are calcuated relative to 1981-2010 climatology")
...
#| fig-cap: !expr paste("Spatial trends of precipitation, relative humidity, and soil moisture anomalies for", cur_mon_nam ,":1950 - ",cur_yr_nam, ".The black dot indicates grid cells with statistically signficnat trends. Anomalies are calcuated relative to 1981-2010 climatology")
...
#Summary table to write text on the report
# Monthly summary
mon_summary_tab_final_f <-
 bind_rows(tmp_mon_plt_lst[[5]],
           vpd_mon_plt_lst[[5]],
           prcp_mon_plt_lst[[5]],
           rh_mon_plt_lst[[5]],
           sm_mon_plt_lst[[5]]
...
# mon_summary_tab_final_f <-
#  bind_rows(tmp_mon_plt_lst$tmean_Sep_ano_trn_summary_table,
#            vpd_mon_plt_lst$vpd_Sep_ano_trn_summary_table,
#            prcp_mon_plt_lst$prcp_Sep_ano_trn_summary_table,
#            rh_mon_plt_lst$rh_Sep_ano_trn_summary_table,
#            sm_mon_plt_lst$soil_moisture_Sep_ano_trn_summary_table
# )
# mon_summary_tab_final_f
...
write.csv(
  ...
  paste0(
    ...
    "/plots/",
    cur_mon_only,
    "_anomalies_trend_summaries_all_par.csv"
  )
)
...
write.csv(
  ...
  paste0(
    getwd(),
    "/plots/seasonal_annual_anomalies_trend_summaries_all_par.csv"
  )
)
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of  mean temperature and VPD for winter:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Trend in spatially averaged anomalies of  mean temperature and VPD for winter:1950 - ",cur_yr_nam, ". Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of precipitation, relative humidity, and soil mositure for winter:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Trend in spatially averaged anomalies of precipitation, relative humidity and soil mositure for winter:1950 - ",cur_yr_nam, ". Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of  mean temperature and VPD for spring:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of precipitation, relative humidity, and soil mositure for spring:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of  mean temperature and VPD for summer:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of precipitation, relative humidity, and soil mositure for summer:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of  mean temperature and VPD for fall:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of precipitation, relative humidity, and soil mositure for fall:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of  mean temperature and VPD for annual:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
...
#| fig-cap: !expr paste("Spatial trends of the anomalies of precipitation, relative humidity, and soil mositure for annual:1950 - ",cur_yr_nam, ".The black dot indicates grids with significant trends. Anomalies are calcuated relative to 1981-2010 climatology.")
