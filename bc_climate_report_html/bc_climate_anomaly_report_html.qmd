...
#| fig-cap: !expr paste("Spatial distribution of the",par_nam,"anomalies relative to the 1980 - 2010 mean:",full_month)
tmn_ano_plt_lst[[1]][[1]]
```
...
#| fig-cap: !expr paste("Spatially averaged",par_nam,"anomalies and trend for BC:",full_month,". The inset box indicates trend magnitude and significance.")
tmn_ano_plt_lst[[1]][[2]]
```
